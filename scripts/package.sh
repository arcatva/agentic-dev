...
install -m 644 "$ROOT/server-rs/sdk-bridge/sdk-bridge.mjs"      "$STAGE/sdk-bridge.mjs"
install -m 644 "$ROOT/server-rs/sdk-bridge/package.json"        "$STAGE/package.json"
install -m 644 "$ROOT/server-rs/sdk-bridge/package-lock.json"   "$STAGE/package-lock.json"
