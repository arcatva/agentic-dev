...
async fn main() {
    ...
    // Rotate ChatGPT-subscription OAuth access tokens before expiry and reload the proxy with the
    // fresh bearer. Cheap no-op until a subscription is logged in.
    crate::engine::oauth::spawn_refresh_task();
